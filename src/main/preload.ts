...
import type { Workspace, AppState, AgentTab, AppPreferences, Plan, TaskAssignment, PlanActivity, Repository, HeadlessAgentInfo, StreamEvent, BranchStrategy, BeadTask, PromptType, DiscoveredRepo, PlanModeDependencies, RalphLoopConfig, RalphLoopState, DescriptionProgressEvent, DiffResult, FileDiffContent, DirectoryListing, FileContent } from '../shared/types'
...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  listDirectoryContents: (directory: string, relativePath?: string): Promise<DirectoryListing> =>
    ipcRenderer.invoke('list-directory-contents', directory, relativePath),
  readFileContent: (directory: string, filepath: string): Promise<FileContent> =>
    ipcRenderer.invoke('read-file-content', directory, filepath),
